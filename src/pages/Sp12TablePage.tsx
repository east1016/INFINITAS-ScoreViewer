    ...
    const fetchData = async () => {
      ...
      try {
        const [songsRes, diffRes, titleRes, konamiInfInfoRes, songInfoJson, chartJson] = await Promise.all([
          fetchJsonWithFallback<any[]>('https://chinimuruhi.github.io/IIDX-Data-Table/difficulty/sp12/songs_list.json'),
          fetchJsonWithFallback<{ [key: string]: { [key: string]: string } }>('https://chinimuruhi.github.io/IIDX-Data-Table/difficulty/sp12/difficulty.json'),
